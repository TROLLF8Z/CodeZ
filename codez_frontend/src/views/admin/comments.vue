<template>
  <el-text style="font-size: 20px; color: #409EFF; font-weight: 500;">根据题目ID搜索题目评论，或根据用户ID搜索用户所有评论</el-text>
  <el-form :model="questionform" label-width="120px" style="margin-top: 30px;" label-position="right" :inline="true">
    <el-form-item label="题目ID">
      <el-input placeholder="请输入题目ID..." v-model="commentform.questionId" @keyup.enter.native="search_comment" />
    </el-form-item>
    <el-form-item label="用户ID">
      <el-input placeholder="请输入题目名称..." v-model="commentform.userId" @keyup.enter.native="search_comment" />
    </el-form-item>
    <el-form-item>
      <el-button type="primary" @click="search_comment" :disabled="searching">搜索评论</el-button>
    </el-form-item>
    <el-form-item>
